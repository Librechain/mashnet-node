...
> {
	...
	let rpc_extensions_builder = {
		...
		Box::new(move |_| {
			...
			// client and pool have to be cloned again, otherwise they would capture the client/pool and this closure
			// could only be called once. But it needs to implement Fn (and not FnOnce).
